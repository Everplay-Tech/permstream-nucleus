...
static const compressor_desc_t comp_desc[] =
{
    ...
    { "permstream", "permstream 0.1",          0,   0,    0,  BENCH_POOL_MT, lzbench_permstream_compress, lzbench_permstream_decompress, NULL,                    NULL },
    { "snappy",     "snappy 1.2.2",            0,   0,    0,  BENCH_POOL_MT, lzbench_snappy_compress,     lzbench_snappy_decompress,     NULL,                    NULL },
    { "tamp",       "tamp v1.10.0",            8,  15,    0,  BENCH_POOL_MT, lzbench_tamp_compress,       lzbench_tamp_decompress,       lzbench_tamp_init,       lzbench_tamp_deinit },
    ...
    { "zxc",        "zxc 0.8.3",               1,   5,    0, BENCH_POOL_MT,  lzbench_zxc_compress,        lzbench_zxc_decompress,        lzbench_zxc_init,        lzbench_zxc_deinit },
};
...
static const alias_desc_t alias_desc[] =
{
    { "FAST", "Refers to compressors capable of achieving compression speeds exceeding 100 MB/s (default alias).",
              ...
              "lzsse4fast/lzsse8,1/lzvn/permstream/quicklz,1,2/snappy/zstd,1,2,3,4,5" }, // default alias
